...
require_once("../cls/informacionanp/presupuestoanualporpartidas.cls.php");
require("../libs/verificar.inc.php"); 
set_time_limit(100);
$link=new Conexion();

$ReporteAPP=new PresupuestoAnualPorPartidas();
$ReporteAPP->anpid=$id;
//echo ($id);
...
$ReporteAPP->ftefto=$ffuente;

$Apartidas=$ReporteAPP->ListarPartidas();
...
<? }?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
		  <tr>	<th align=center class="tit" ><strong>Partidas por Tareas - POA   <?=axo($_SESSION[inrena_4][2]) ?></th>  
		  </tr>
		</table>
<hr width="100%">
		  ...
		  <tr>
			...
			<table width="100%"  border="1" cellspacing="0" cellpadding="0" class="tab">
			  <tr>
					...
					<th class="th2" width="24%" rowspan="2" align="center">Programas/Subprogramas/Actividades</th>
			...
			<?
			$ReporteAPP->mostrar_Presupuesto($ffuente);
			?>
			</table>      
