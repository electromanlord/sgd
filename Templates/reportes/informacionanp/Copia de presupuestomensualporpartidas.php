...
require_once("../cls/informacionanp/reporte_meses.php"); 
...
<? }?>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
		  <tr>	<th align=center class="tit" ><strong>Partidas por Tareas - POA   <?=axo($_SESSION[inrena_4][2])?><?=$_POST[idmes]?></th>  
		  </tr>
		</table>
<hr width="100%">
		  ...
		  <tr>
			...
			<table width="100%"  border="1" cellspacing="0" cellpadding="0" class="tab">
			  <tr>
					...
					<th class="th2" width="24%" rowspan="2" align="center">Resultado/Tareas</th>
