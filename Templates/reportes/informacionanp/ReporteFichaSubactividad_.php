...
<?
	session_start();
	//echo "--->"; print_r($_SESSION['id_ff_anp']);
...
<table align="center" bgcolor="#FFFFFF" width="100%" id="ficha">
  <!--DWLayoutTable-->
	...
	<tr>
		<td class="descripcion"><?=$rws[1].".".$rw[1].".".$row[nro_asignacion]?></td>
	...
	<tr>
		<td colspan="3" valign="top" bgcolor="#999999" class="titulo">Descripci&oacute;n de Tarea </td>
