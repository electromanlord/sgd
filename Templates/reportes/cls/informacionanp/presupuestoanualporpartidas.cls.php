<?
class PresupuestoAnualPorPartidas extends SqlSelect {
var $md=false;
var $simbolomd=" S/. ";
var $sql;
var $ftefto;
var $APartidas;
	...
	function PresupuestoAnualPorPartidas(){
	...
	function mostrar_ff_chk($fuente=''){
		...
		$funcjs=" mostrar_presupuestoanualporpartidas";
	...
	function setsql($sql=''){
		...
		if ($this->md){
			$selmescampos="sum(monto_programacion_partidas_meses".$sqlmultiplicarxtc.") as total_monto,  id_partida ";
		}
	...
	function generar_td($cls){
			$monto=sumar_partidas_programado($this->sql);
			$td='';
