...
<table width="100%" border="4"  bordercolor="#6699CC" align="center">
    ...
    <td onmouseover="toolTips('<?php echo $row_reg['asunto_documento']?>',this)"  ><a href="escaneo_acceso_registro.php?opcion=edit&id=<?=$id?>"><?=$row_reg[1]?></a></td>
      ...
      <!---<td ><?=$row_reg[4]?></td>--->
      <td > <?php echo date('d/m/Y H:i',strtotime($row_reg['fecha_Escaneo_documento']))?></td>
...
<form id="f3" name="f3" method="post" action="<?php echo	$_SERVER['PHP_SELF']?>?opcion=guardar">
  ...
  <table width="93%" border="1" align="center" >
    ...
    <tr class="Estilo2">
      ...
      <td width="89" class="Estilo2"><div align="left" class="Estilo2" >Instituci&oacute;n:</div></td>

      <td width="309" ><span class="Estilo2">
...
?>
      ...
      <td width="101" class="Estilo2">Tipo de Documento :</td>

      <td width="238" class="Estilo2"><span class="Estilo2">
...
<select name="tipo">
	    ...
	    <option value="<?=$row_tipo[0]?>"<? if(isset($_POST['tipo']) && $_POST['tipo']== $row_tipo[0]){ echo "selected";} ?>><?=$row_tipo[1]?>
        </option> <?  } ?>	
        </select>

      </span> </td>

      <td width="42" bgcolor="#FFFFFF"><div align="left" class="Estilo2"> Folios</div>        </td>
      ...
      <td width="89" class="Estilo2"><div align="left" class="Estilo2">Nro. Doc:</div></td>
      ...
      <td width="42" bgcolor="#FFFFFF" class="Estilo2"><div align="left" class="Estilo2">Fecha </div></td>
...
?>
    ...
    <tr>
      <td width="80" class="Estilo2"><div align="left" class="Estilo2">Nro. Doc:</div></td>
      <td bgcolor="#FFFFFF"><span class="Estilo2">
        <input name="num_doc2" type="text" id="num_doc2" value="<?=$row_1[3]?>" size="48" />
      </span></td>
      <td class="Estilo2" align="right">Folios</td>
      <td class="Estilo2"><input name="num_folio2" type="text" value="<?=$row_1[6]?>" size="10" /></td>
