...
<form id="form_registrar_documento" name="form_registrar_documento" method="post" action="<?php echo	$_SERVER['PHP_SELF']?>?opcion=guardar">
  ...
  <table width="90%" border="0" align="center" class="formularios">
    ...
    <tr class="Estilo2">
      ...
      <td width="296" class="Estilo2">
        <div align="left">
          <input name="remitente" type="text" class="doc_remitente caja" id="text_remitente" style="width:290px">
	  ...
	  <?
		...
		?>
        <div align="left">
          <select name="tipo" class="tipo_doc caja">
